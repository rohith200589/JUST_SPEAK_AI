...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
    ...
    <Link to={feature.path} key={index} className="no-underline">
        <div className="p-8 card-bg rounded-xl shadow-lg  flex flex-col items-center text-center hover:scale-105 transition-transform duration-300 cursor-pointer">
